...
describe Puppet::Transaction::Report do
  ...
  it "should be able to set noop_run to true" do
    Puppet[:noop] = true
    report = Puppet::Transaction::Report.new("apply")
    expect(report.noop_run).to be_truthy
  end

  it "should be able to set noop_run to false" do
    Puppet[:noop] = false
    report = Puppet::Transaction::Report.new("apply")
    expect(report.noop_run).to be_falsey
  end

  it "should be able to set noop_run to false in Puppet[:noop] is unset" do
    Puppet[:noop] = nil
    report = Puppet::Transaction::Report.new("apply")
    expect(report.noop_run).to be_falsey
  end
